...
export default function Services() {
  const services = [
    {
      title: "Express Entry",
      desc: "Fast-track PR for skilled workers.",
      link: "/services/express-entry",
    },
    {
      title: "Rural Community Immigration Pilot (RCIP)",
      desc: "Rural Community Immigration Pilot.",
      link: "/services/rcip",
    },
    {
      title: "Provincial Nomination Program (PNP)",
      desc: "Province-specific PR pathways.",
      link: "/services/pnp",
    },
    {
      title: "Study in Canada (Student Visa)",
      desc: "Study in Canada & pathway to PR.",
      link: "/services/student-visa",
    },
    {
      title: "Tourist Visa ",
      desc: "Canada tourist visa services.",
      link: "/services/visit-visa",
    },
    {
      title: "Super Visa",
      desc: "Long-term visa for parents & grandparents.",
      link: "/services/super-visa",
    },
    {
      title: "Entrepreneur Immigration",
      desc: "Start a business in Canada.",
      link: "/services/entrepreneur-immigration",
    },
    {
      title: "Work Permit",
      desc: "Intra-Company Transfer work permits.",
